...
namespace SynchrophasorAnalytics.Measurements
{
    ...
    [Serializable()]
    public class CurrentInjectionPhasorGroup : PhasorGroup, ICsvReportable
    {
        ...
        public static string CSV_HEADER = $"InternalID,Number,Acronym,Name,Description,Enabled,Use Status,Status,PosSeq Magnitude Measurement Key,PosSeq Angle Measurement Key,PosSeq Magnitude Estimate Key,PosSeq Angle Estimate Key,PosSeq Magnitude Measurement,PosSeq Angle Measurement,PosSeq Magnitude Estimate,PosSeq Angle Estimate,Node,Convention,Reported,Include In Estimator{Environment.NewLine}";
        ...
        public new string ToCsvLineString()
        {
            ...
            stringBuilder.AppendFormat($"{MeasuredConnectedNode.ParentSubstation.Name}_{MeasuredConnectedNode.Name},");
            stringBuilder.AppendFormat($"{MeasurementDirectionConvention},");
