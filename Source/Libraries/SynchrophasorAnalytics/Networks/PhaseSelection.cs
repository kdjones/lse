...
{
    /// <summary>
    /// An enumeration used to determine whether the <see cref="LinearStateEstimator.Networks.Network"/> should be considered as full three phase model or a positive sequence equivalent.
    /// </summary>
    [Serializable()]
