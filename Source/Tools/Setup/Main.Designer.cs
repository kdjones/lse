namespace Setup
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelInstallationOptions.Text = "This setup utility will install the LinearStateEstimator and/or related tools. This inst" +
    "allation requires .NET 4.5 and is only available as a 64-bit installation.";
            ...
            this.Text = "LinearStateEstimator Setup";
